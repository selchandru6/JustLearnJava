...
/**
 * Date : July 28, 2020 3:00:33 PM Purpose : Sorting is to place elements in
 * increasing or decreasing order. Insertion sort is a simple sorting algorithm
 * . In this sorting algorithm , the final sorted array can be build one at a
 * time .For larger data , when compared to other sorting techniques like quick
 * sort , heap sort or merge sort ,it falls short .
 * 
